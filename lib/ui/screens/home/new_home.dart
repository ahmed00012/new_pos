                        ...
                        itemBuilder: (context, i) {
                          return i == 0
                              ...
                              : CategoryItem(
                                  ...
                                  title: viewModel.categories[i - 1].title!.en!,
                                ...
                                return viewModel.options &&
                                    ...
                                    : ProductItemWidget(
                                        onTap: () {
                                          if (!viewModel.options) {
                                            ...
                                            ConstantStyles.showPopup(context: context,
                                                content: SingleItem(
                                                  index: cartController.orderDetails.cart!.length - 1,
                                                  customer: cartController.orderDetails.customer != null,
                                        ...
                                        title: viewModel.options
                                            ...
                                            : viewModel.products[i].title!.en!,
                                        image:
                                            viewModel.products[i].image!.image!,
