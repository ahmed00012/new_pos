                  ...
                  itemBuilder: (context, i) {
                    return InkWell(
                      ...
                      if (viewModel.orderStatus[i].id != null)
                        viewModel.orderStatusFilter(i, viewModel.orderStatus[i].id!);
                      else
                        viewModel.allFilter();
                    }
                  },
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                decoration: BoxDecoration(
                                                    ...
                                                    border: Border.all(
                                                        color:
                                                        viewModel.orders[i].ownerName!=null?
                                                        Constants.secondryColor:
                                                        viewModel.orders[i].paymentStatus==0 && viewModel.orders[i].orderStatusId != 5
                                                  ...
                                                  child: Padding(
                                                      ...
                                                      Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          if (viewModel.orders[i].ownerName !=
                                                              null)
                                                            Text(
                                                              viewModel.orders[i].ownerName!,
                                                              style: TextStyle(
                                                                  fontSize: size.height * 0.02,

                                                                  color: Constants.lightBlue),
                                                            ),
                                                          if (viewModel.orders[i].orderStatusId == 7)
                                                            Icon(
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            border: Border.all(
                                              ...
                                              viewModel.orders[i].ownerName!=null?
                                              Constants.secondryColor:
                                              viewModel.orders[i].paymentStatus==0?Colors.red:
                                              Constants.mainColor,
                                            )),
                                        child: Center(
                                          child: Image.asset(
